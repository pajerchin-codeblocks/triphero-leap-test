    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl h-96">
            {!playVideo ? (
              <>
                <video
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/sk_verzia_1_v1%20%28540p%29-RlPn6eDvVfIPKQDoIncfigo1279vou.mp4"
      ...
      <section id="benefits" className="px-6 py-20 md:py-32 bg-background">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            <Button
              size="lg"
              className="bg-accent hover:bg-accent/90 text-white text-lg px-10 rounded-full"
              onClick={handleStartPlanning}
            >
              Začať plánovať camp
            </Button>
      ...
      <section className="px-6 py-20 md:py-32 bg-gradient-to-r from-accent/10 via-background to-accent/5">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <Button
            size="lg"
            className="bg-accent hover:bg-accent/90 text-white text-xl px-12 py-7"
            onClick={handleStartPlanning}
          >
            Začať plánovať camp
          </Button>
