  ...
  return (
    <>
      <motion.nav
        ...
        className="fixed top-0 left-0 right-0 z-[70] transition-all duration-300 bg-background/95 backdrop-blur-md shadow-soft border-b border-border/50 h-16 md:h-20"
      >
